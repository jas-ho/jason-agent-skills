...
The table below lists the marketplace subset. Jason's local Claude Code, Codex and OMP setup also uses other packages under `plugins/`; its selection and generated discovery paths are owned by `~/.claude/agent-config.toml`.
